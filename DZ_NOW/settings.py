"""
Django settings for DZ_NOW project.
...
SECRET_KEY = 'xqx8kqxfas%uj9yrl@7-58#t&3^2mj^)@ol8+8%)mk57_cu^fn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', False)

ALLOWED_HOSTS = ['.dznow.com', '.dznow.herokuapp.com']
if DEBUG:
...
WSGI_APPLICATION = 'DZ_NOW.wsgi.application'
